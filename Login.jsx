    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        <div className="relative">
          <h1 className="text-2xl font-semibold mb-1 text-center text-gray-900 dark:text-gray-100">Welcome back</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400 text-center mb-6">Log in to DocChat</p>
